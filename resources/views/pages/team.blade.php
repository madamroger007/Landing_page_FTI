            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-xxl-8">
                    <div class="text-center my-5">
                        ...
                        <p class="text-muted">
                            I am a student at Bale Bandung University, I am currently 22 and I have a hobby of Ngoding. I
                            also hope to become a professional programmer and be the best.
                            and I try my best to study harder every day and in the future I want to be a useful person for
                            my family and surroundings</p>
                        <div class="d-flex justify-content-center fs-2 gap-4">
                            <a class="text-gradient" href="mailto:adamsetiadijr07@gmail.com" target="_blank"><i
                                    class="bi bi-google"></i></a>
                            <a class="text-gradient" href="https://www.linkedin.com/in/adamstdi" target="_blank"><i
                                    class="bi bi-linkedin"></i></a>
                            <a class="text-gradient" href="https://github.com/madamroger007" target="_blank"><i
