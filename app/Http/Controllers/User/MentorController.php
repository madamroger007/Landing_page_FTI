...
class MentorController extends Controller
{
    ...
    {
        return view('dashboard.page.teacher.add-teacher');
    }
...
public function teacherList()
{
    $listTeacher = DB::table('users')
        ...
        ->get();
    return view('dashboard.page.teacher.list-teachers',compact('listTeacher'));
}

/** teacher Grid */
public function teacherGrid()
{
    $teacherGrid = Mentor::all();
    return view('dashboard.page.teacher.teachers-grid',compact('teacherGrid'));
}
...
public function saveRecord(Request $request)
{
 ...
 {
     $teacher = Mentor::where('id',$id)->first();
     return view('dashboard.page.teacher.edit-teacher',compact('teacher'));
 }
 ...
 public function updateRecordTeacher(Request $request)
 {
     ...
     try {
         ...
         Mentor::where('id',$request->id)->update($updateRecord);
