...
class SiswaController extends Controller
{
     ...
     public function student()
     {
         ...
         return view('dashboard.page.student.student',compact('studentList'));
     }
    ...
    {
        $studentList = Siswa::all();
        return view('dashboard.page.student.student-grid',compact('studentList'));
    }

     /** student add page */
     public function studentAdd()
     {
         return view('dashboard.page.student.add-student');
     }
    ...
    {
        $studentEdit = Siswa::where('id',$id)->first();
        return view('dashboard.page.student.edit-student',compact('studentEdit'));
    }
    ...
    public function studentUpdate(Request $request)
    {
        ...
        try {
            ...
            Siswa::where('id',$request->id)->update($updateRecord);
    ...
    {
        $studentProfile = Siswa::where('id',$id)->first();
        return view('dashboard.page.student.student-profile',compact('studentProfile'));
    }
